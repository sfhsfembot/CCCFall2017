...
public class OI {
    ...
    public JoystickButton climberMotorClimbUpToggleStartButton;
    public JoystickButton climberMotorClimbUpToggleDoneStartButton;
    ...
    public JoystickButton driveModeToggleButton7;
    public JoystickButton driveModeToggleDoneButton7;
    public JoystickButton modeTypeToggleButton8;
    public JoystickButton modeTypeToggleDoneButton8;
    ...
    public OI() {
        ...
        modeTypeToggleDoneButton8 = new JoystickButton(joystick, 8);
        modeTypeToggleDoneButton8.whenReleased(new ModeTypeToggleDone());
        modeTypeToggleButton8 = new JoystickButton(joystick, 8);
        modeTypeToggleButton8.whenPressed(new ModeTypeToggle());
        driveModeToggleDoneButton7 = new JoystickButton(joystick, 7);
        driveModeToggleDoneButton7.whenReleased(new DriveModeToggleDone());
        driveModeToggleButton7 = new JoystickButton(joystick, 7);
        driveModeToggleButton7.whenPressed(new DriveModeToggle());
        intakeMotorReverseToggleDoneButton3 = new JoystickButton(joystick, 3);
        intakeMotorReverseToggleDoneButton3.whenReleased(new IntakeMotorReverseToggleDone());
        ...
        intakeMotorForwardToggleDoneButton1.whenReleased(new IntakeMotorForwardToggleDone());
        ...
        feederMotorReverseToggleDoneBackButton.whenReleased(new FeederMotorReverseToggleDone());
        ...
        climberMotorClimbUpToggleDoneStartButton = new JoystickButton(gamepad, 8);
        climberMotorClimbUpToggleDoneStartButton.whenReleased(new ClimberMotorClimbUpToggleDone());
        climberMotorClimbUpToggleStartButton = new JoystickButton(gamepad, 8);
        climberMotorClimbUpToggleStartButton.whenPressed(new ClimberMotorClimbUpToggle());


        // SmartDashboard Buttons
        SmartDashboard.putData("AutonomousCommand", new AutonomousCommand());
        SmartDashboard.putData("ClimberMotorClimbUpToggle", new ClimberMotorClimbUpToggle());
        SmartDashboard.putData("ClimberMotorClimbUpToggleDone", new ClimberMotorClimbUpToggleDone());
        ...
        SmartDashboard.putData("DriveModeToggle", new DriveModeToggle());
        SmartDashboard.putData("DriveModeToggleDone", new DriveModeToggleDone());
        SmartDashboard.putData("ModeTypeToggle", new ModeTypeToggle());
        SmartDashboard.putData("ModeTypeToggleDone", new ModeTypeToggleDone());
